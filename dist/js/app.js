(() => {
    ...
    (() => {
        ...
        function tabs() {
            ...
            const personalCabinetTabs = document.querySelector(".personal-cabinet__tabs");
            if (personalCabinetTabs) {
                const tabs = document.querySelectorAll("[data-tabs]");
                let tabsActiveHash = [];
                if (tabs.length > 0) {
                    const hash = functions_getHash();
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) {
                ...
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".menu__burger")) {
                        bodyLockToggle();
        ...
        function formSubmit(options = {
            ...
            function formSent(form, responseResult = ``) {
                ...
                setTimeout((() => {
                    form.dataset.popupMessage;
                    form.parentElement.classList.add("_active");
                }), 0);
                setTimeout((() => {
                    if (flsModules.popup) {
 ...
 */        !function(e, t) {
        ...
        if (document.querySelector(".main-clients__slider")) new core(".main-clients__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            spaceBetween: 20,
        ...
        function aboutSlider() {
            if (document.querySelector(".about-documents__slider")) new core(".about-documents__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        if (payItems) {
            ...
            if (payItems) payItems.forEach((item => {
        ...
        function rates() {
            if (ratesItems) {
                ...
                if (ratesItems) ratesItems.forEach((item => {
                    item.addEventListener("click", (function(e) {
        ...
        if (getOfferButton) getOfferButton.forEach((button => {
            button.addEventListener("click", (function(e) {
                getOfferShadow.classList.add("_active-offer");
                getOfferBlock.classList.add("_active-offer");
                if (getOfferLoginBlock) getOfferLoginBlock.classList.remove("_active-offer");
                bodyLock();
            }));
        ...
        if (getOfferButtonConnection) getOfferButtonConnection.forEach((button => {
            button.addEventListener("click", (function(e) {
                getOfferShadow.classList.add("_active-offer");
        ...
        if (inputs) inputs.forEach(((input, index) => {
            input.addEventListener("input", (({target}) => {
                target.value = target.value.replaceAll(/\D+/g, "").slice(0, 1);
                if (1 === target.value.length && void 0 !== inputs[index + 1]) {
                    inputs[index + 1].classList.add("_active");
                    inputs[index + 1].focus();
                    inputs[index + 1].select();
                } else inputs[index + 1].classList.remove("_active");
            }));
        }));
